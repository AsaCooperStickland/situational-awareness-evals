...
from sitaevals.common import is_main_process
from sitaevals.evaluation import _legacy_evaluate_completions
...
def get_compute_metrics_fn(
    ...
    def compute_metrics(eval_preds: EvalPrediction) -> Dict:
        ...
        if wandb.config.natural_instructions and tasks:
            ...
            eval_tasks = eval_tasks.union(info["unrealized_extra_tasks"])
            eval_results = {"accuracies_per_task": {}}
            ...
            for eval_type, examples in eval_type2examples.items():
                ...
                # convert from data frame with "task" and "correct" columns to dictionary
                for task in eval_tasks:
                    # hack for many prompt evaluations
