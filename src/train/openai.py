    ...
    *e_files: str,
    ...
    if len(e_files) > 0:
        ...
        inference_tokens = sum(
            [len(GPT3Tokenizer.encode(prompt)) for prompt in inference_prompts]
        )
        inference_cost = (inference_tokens / 1000) * get_cost_per_1k_tokens(
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--v_file", type=str, default="", required=False, help="Validation file"
    )
